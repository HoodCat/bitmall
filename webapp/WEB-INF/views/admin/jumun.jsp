    ...
    <div align="center">
        ...
        <table width="800" border="0" cellspacing="0" cellpadding="0">
          <tr height="40">
            <td align="left" width="100" valign="bottom">
              &nbsp 주문수 : <font color="#FF0000">20</font>
            </td>
      ...
      <table width="800" border="1" cellspacing="0" cellpadding="0" bordercolordark="white" bordercolorlight="black">
          ...
          <tr bgcolor="#F2F2F2" height="23">
            <form method="post" action="">
              <td width="70" align="center">
                <a href="jumun/info?no=0803030002">${order.no}</a>
              </td>
              <td width="70" align="center">${order.orderDate}</td>
              <td width="250" align="left">&nbsp;${order.goodsName}</td>
              <td width="40" align="center">${order.totalAmount}</td>
              <td width="70" align="right">${order.totalPrice}</td>
              <td width="65" align="center">${order.memberName}</td>
              <c:choose>
                <c:when test="${order.paymentMethod}">
                  <td id="payment-method" width="50" align="center">카드</td>                
                </c:when>
                <c:otherwise>
                  <td id="payment-method" width="50" align="center">무통장</td>                                
                </c:otherwise>
              </c:choose>
              <td width="135" align="center" valign="bottom">
                <select name="status" style="font-size: 9pt; color: blue">
                  <option value="1">주문신청</option>
                  <option value="2">주문확인</option>
                  <option value="3">입금확인</option>
              ...
              <td width="50" align="center" valign="bottom">
                <a href="">
                  <img src="${pageContext.servletContext.contextPath }/assets/images/admin/b_delete1.gif" border="0">
                </a>
              </td>
            </form>
          </tr>
        ...
        <%-- <tr bgcolor="#F2F2F2" height="23">
          <form method="post" action="">
            <td width="70" align="center">
              <a href="jumun_info.jsp?no=0803010006">0803010006</a>
            </td>
            ...
            <td width="135" align="center" valign="bottom">
              ...
              </select>&nbsp; <input type="image" src="${pageContext.servletContext.contextPath }/assets/images/admin/b_edit1.gif" border="0">
            </td>
            <td width="50" align="center" valign="bottom">
              <a href="">
                <img src="${pageContext.servletContext.contextPath }/assets/images/admin/b_delete1.gif" border="0">
      ...
      <table width="800" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="30" class="cmfont" align="center">
            ...
            <a href="jumun.jsp?page=2&sel1=&sel2=&text1=&day1_y=&day1_m=&day1_d=&day2_y=&day2_m=&day2_d=">
              <font color="#7C7A77">[2]</font>
            </a>&nbsp; 
            <a href="jumun.jsp?page=3&sel1=&sel2=&text1=&day1_y=&day1_m=&day1_d=&day2_y=&day2_m=&day2_d=">
