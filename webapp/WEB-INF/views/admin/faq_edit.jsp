    ...
    <form name="form1" method="post" action="">
      ...
      <table width="600" border="1" cellspacing="0"
        ...
        <tr>
          ...
          <td width="500" height="20" bgcolor="#F2F2F2">&nbsp <input
            type="text" name="title" value="자주질문1" size="67">
          </td>
        </tr>
        <tr>
          <td width="100" height="20" bgcolor="#CCCCCC" align="center">
          ...
          <td width="500" height="20" bgcolor="#F2F2F2">&nbsp <textarea
              name="content" rows="7" cols="65">자주하는 질문 1번입니다. 답변은 이렇습니다.</textarea>
          </td>
        </tr>
      </table>
      <br>
      <table width="600" border="0" cellspacing="0" cellpadding="7">
        <tr>
          <td align="center"><input type="submit" value="등 록 하 기">
            &nbsp;&nbsp <a href="faq.jsp"><input type="button"
              value="이 전 화 면"></a></td>
        </tr>
      </table>
